...
def apply_all_testing(host,db_name,pass_sygnal_backtest=False,pass_sygnal_prophet=False,pass_sygnal_recomendation=False):
...
if __name__== "__main__":
    host = "mongodb://localhost:27017/"
    db_name = "db_pasanti"
    apply_all_testing(host=host,db_name=db_name,pass_sygnal_backtest=True, pass_sygnal_recomendation=False, pass_sygnal_prophet=True)